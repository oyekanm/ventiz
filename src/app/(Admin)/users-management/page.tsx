...
import { FunctionalButton, Loader, Pagination, UserInfoCard } from '@/components/reuseable';
              ...
              <tbody>
                {filteredItems.slice(indexOfFirstItem, indexOfLastItem).map((user:User) => (
                  <tr key={user._id} className="border-b h-[7.2rem]">
                    ...
                    <td className="td">
                      <button onClick={()=>setPayload(user)} className="text-blue-600 font-medium hover:underline">View details</button>
                    </td>
