...
import { CalendarPlus2, Clock, Eye, LockKeyhole, MapPin, Trash2, X } from 'lucide-react';
...
const EventCreateForm = ({ close }: ModalProps) => {
    ...
    const [eventData, setEventData] = useState<Partial<EventData>>({
        ...
        "eventType": "",
        "eventTag": [],
        "giftLink": "https://example.com/gift-link",
        "inviteOnly": true,
        "tickets": [
            {
                "type": "",
    ...
    const removeImage = (indexToRemove: string) => {
        if (eventData?.url?.length === 0) return;
        ...
        <div className="fixed bg-[#ffff7] z-[10000] backdrop-blur-[5px] bottom-0 left-0 right-0 top-0 h-full">
            <div className="max-w-[62rem] flex flex-col gap-4 h-full w-full mx-auto  bg-white rounded-lg shadow">
                        ...
                        {activeTab === 'basic' && (
                            <div className="space-y-6 ">
                                <div className={inputCon}>
                                    ...
                                    <UploadEventBanner onUploadSuccess={saveImage} />
                                </div>
                                    ...
                                    <div className={inputCon}>
                                        ...
                                        <div className="auth-input-container !w-full">
                                            <input
                                                ...
                                                className="auth-input"
                                                placeholder="DD-MM-YYY"
                                                value={eventData.publishSchedule.startDate}
                                    ...
                                    <div className={inputCon}>
                                        ...
                                        <div className="auth-input-container !w-full">
                                            <input
                                                ...
                                                name="publishSheduletime"
                                                className="auth-input"
                                                value={eventData.publishSchedule.startTime}
                ...
                <div className="flex justify-end space-x-4 p-4 border-b ">
                    <FunctionalButton noIcn click={close} text='Discard changes' txtClr='text-[#344054]' bgClr='#ffff' clx='border border-[#D0D5DD]' />
                    {!sending && <FunctionalButton disable={sending} click={createEvent} noIcn text={activeTab === 'publish' ? 'Publish event' : 'Save and Continue'}
